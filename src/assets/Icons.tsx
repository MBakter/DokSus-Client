...
export const IconPDF = ({ className = "text-blue-700" }: { className?: string }) => (
...
export const IconDownload = ({ className = "w-[18px] h-[18px] text-slate-400" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
         strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const IconChevronDown = ({className}: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "w-5 h-5"} viewBox="0 0 24 24" strokeWidth="2"
